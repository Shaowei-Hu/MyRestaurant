...
import com.shaowei.restaurant.repository.CategoryRepository;
import com.shaowei.restaurant.service.CategoryService;
import com.shaowei.restaurant.repository.search.CategorySearchRepository;
...
public class CategoryResourceIntTest {
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getRanking()).isEqualTo(DEFAULT_RANKING);
    ...
    public void updateCategory() throws Exception {
        ...
        assertThat(testCategory.getRanking()).isEqualTo(UPDATED_RANKING);
